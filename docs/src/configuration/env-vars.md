...
| `AENV_METERING_ENABLED` | `true` | Override `[metering].enabled`, per-sandbox CPU/memory/disk usage metering |
| `AENV_METERING_SAMPLE_INTERVAL_SECS` | `5` | Override `[metering].sample_interval_secs` |
